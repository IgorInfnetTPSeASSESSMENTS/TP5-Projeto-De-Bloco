...
class CancelAdoptionRequestCommandHandlerTest {
    ...
    void setUp() {
        ...
        handler = new CancelAdoptionRequestCommandHandler(gateway, notificationGateway);
